### OOO 사업부 소속이면서 OOO 사업부의 과제에 속한 케이스 집계
#### Prompt
```
projects_by_id_marked_v2.md 파일에서만 데이터를 사용해서,
1. '참여자 개인의 소속(department)' 필드를 기준으로 DPC 인원을 식별하고,  
2. 각 인원이 참여한 과제의 '과제 사업부(project department)'를 별도로 확인해,  
3. 개인의 소속과 과제의 사업부가 서로 다를 경우만 리스트로 정리해줘.  
형식은 "이름 : 과제명(과제 사업부, 시작일 ~ 종료일, 총 OO일)"로 보여줘.  
모든 정보는 파일 원문 그대로를 사용하고 추정·가정·요약을 하지 마.
```
...
| 연도 | BDC | 전장 | MX | DA | 네트워크 | VD | SR | 의료기기 | DPC | GCS | 전사 | 합계 |
|------|-----|------|----|----|----------|----|----|----------|-----|-----|------|------|
| 2021 | 6(0) | 5(0) | 15(0) | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 26(0) |
| 2022 | 5(0) | 2(0) | 48(3) | 1(0) | 6(1) | 9(0) | 8(1) | 2(0) | 2(0) | 0 | 0 | 83(5) |
| 2023 | 3(0) | 2(1) | 69(5) | 2(0) | 8(1) | 7(1) | 11(1) | 4(1) | 4(0) | 0 | 2(0) | 112(9) |
| 2024 | 3(0) | 1(0) | 61(3) | 2(0) | 11(1) | 7(1) | 13(2) | 3(0) | 9(1) | 2(0) | 2(0) | 114(8) |
| 2025 | 2(0) | 3(1) | 56(3) | 3(0) | 10(1) | 6(1) | 15(2) | 1(0) | 10(1) | 3(0) | 5(1) | 114(10) |
| 2026 | 1(0) | 1(0) | 39(2) | 1(0) | 7(1) | 4(1) | 9(1) | 0 | 3(0) | 2(0) | 2(0) | 69(5) |
| **합계** | **20(0)** | **14(2)** | **288(16)** | **9(0)** | **42(5)** | **33(4)** | **56(7)** | **10(1)** | **28(2)** | **7(0)** | **11(1)** | **879(38)** |
